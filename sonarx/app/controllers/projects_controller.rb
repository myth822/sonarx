class ProjectsController < ApplicationController
  ...
  # GET /projects.fxml
  def index
    # @projects = Project.find_all_by_category('dim')
    #@projects = Project.find_all_by_category(params[:category])
    @projects = Project.find(:all)

    respond_to do |format|
      format.html # index.html.erb
      format.xml  { render :xml => @projects }
      #format.fxml  { render :fxml => @projects.to_xml(:include => :project_group)}
